export const metaMorphoFactoryAbi = [
  ...
  },
  {
    ...
    outputs: [{ name: "metaMorpho", type: "address", internalType: "contract IMetaMorpho" }],
    stateMutability: "nonpayable",
  },
  {
    type: "function",
  ...
  },
  {
    ...
    name: "CreateMetaMorpho",
    inputs: [
      { name: "metaMorpho", type: "address", indexed: true, internalType: "address" },
      { name: "caller", type: "address", indexed: true, internalType: "address" },
      { name: "initialOwner", type: "address", indexed: false, internalType: "address" },
      { name: "initialTimelock", type: "uint256", indexed: false, internalType: "uint256" },
